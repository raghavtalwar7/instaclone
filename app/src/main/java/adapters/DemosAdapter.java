...
public class DemosAdapter extends BaseAdapter {
    ...
    public final static int VIDEO_PICKER_ACTIVITY = 2;
    public final static int FILE_PICKER_ACTIVITY = 3;
    public final static int CONTACT_PICKER_ACTIVITY = 4;
        public final static int AUDIO_PICKER_ACTIVITY = 5;
